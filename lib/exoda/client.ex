defmodule Exoda.Client do
  ...
  """
  @callback request(method :: atom, url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) 
  ...
  """
  @callback get!(url :: String.t, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t

  @doc """
  Issues a PUT request to the given url.
  See `HTTPoison.Base.put/4`.
  """
  @callback put(url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) 
    :: {:ok, Response.t | AsyncResponse.t } | {:error, Error.t}
  ...
  See `HTTPoison.Base.put!/4`.
  """
  @callback put!(url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t
  ...
  See `HTTPoison.Base.head!/3`
  """
  @callback head!(url :: String.t, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t

  @doc """
  Send a POST request. 
  See `HTTPoison.Base.post/4`.
  """
  @callback post(url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) 
  ...
  See `HTTPoison.Base.post!/4`.
  """
  @callback post!(url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t

  @doc """
  Send a PATCH request. 
  See `HTTPoison.Base.patch/4`.
  """
  @callback patch(url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) 
    :: {:ok, Response.t | AsyncResponse.t} | {:error, HTTPoison.Error.t}
  ...
  See `HTTPoison.Base.patch!/4`.
  """
  @callback patch!(url :: String.t, body :: any, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t
  ...
  See `HTTPoison.Base.delete!/3`
  """
  @callback delete!(url :: String.t, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t
  ...
  See `HTTPoison.Base.options/3`
  """
  @callback options!(url :: String.t, headers :: HTTPoison.headers, opts :: Keyword.t) :: Response.t | AsyncResponse.t
end
